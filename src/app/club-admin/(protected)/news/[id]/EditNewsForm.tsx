  ...
  return (
    <div className="max-w-2xl">
      ...
      <form action={formAction} className="space-y-5">
        ...
        <RichTextEditor name="content" label="Περιεχόμενο άρθρου (ελλ.)" defaultValue={article.content} />
        <RichTextEditor name="contentEn" label="Περιεχόμενο άρθρου (αγγλ.)" defaultValue={article.contentEn} />
